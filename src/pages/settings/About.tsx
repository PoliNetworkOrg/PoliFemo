        ...
        <ContentWrapperScroll title="Su quest'app">
            <View style={{ paddingTop: 32, paddingBottom: 80 }}>
                ...
                <BodyText style={{ paddingHorizontal: 32, paddingBottom: 16 }}>
                    ...
                    Un&apos;app pensata per semplificare la vita di tutti gli
                    studenti del Politecnico permettendo a loro di potersi
                    concentrare al massimo sullo studio e lasciare il resto a
                    PoliFemo{"\n"}
                    Svilluppata con ❤️ da PoliNetwork{"\n"}
                    {"\n"}
                    <Title style={{ fontSize: 24 }}>Source code{"\n"}</Title>
                    Polifemo è un progetto open source, puoi contribuire al suo
                    sviluppo su GitHub!{"\n"}
                    Client:{" "}
                ...
                <SettingTile
                    setting={{
                        ...
                        subtitle:
                            "Segnala un bug o suggerisci una nuova funzionalità",
                        callback: () =>
                            Linking.openURL(
                ...
                {loggedIn ? (
                    <SettingTile
                        setting={{
                            ...
                            subtitle:
                                "Copia il tuo ID utente PoliNetwork negli appunti",
                            callback: async () => {
                ...
                <SettingTile
                    setting={{
                        title: "Licenze",
                        subtitle:
                            "Visualizza le licenze dei pacchetti utilizzati",
                        callback: () => {
                            navigate("Licenses")
                        },
                    }}
